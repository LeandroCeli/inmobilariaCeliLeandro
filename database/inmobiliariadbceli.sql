...
CREATE DATABASE IF NOT EXISTS InmobiliariaDBCeli CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
VALUES (
        3,
        'admin@inmobiliaria.com',
        '$2a$11$PZy/IqArdg1PcvLLyIqQu.JIuJAbvGxHJzPLKlUo38SSW03qe2U12',
    ...
    (
        9,
        'test@inmobiliaria.com',
        '$2a$11$/J2zHDTaJxyOHE7hrnHC2u98HylHJ1y.8RYNNl9.icKqVDPKcw7HS',
        'Empleado 1',
        '1',
        NULL
    );
...
--
ALTER TABLE `inquilinos` ADD PRIMARY KEY (`Id`);
